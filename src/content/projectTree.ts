...
export class ProjectTree {
  ...
  constructor(options: ProjectTreeOptions) {
    ...
    this.projectTree = {
      ...
      children: [
        { id: "scenes", type: "section", title: "Scenes", children: [] },
        { id: "actors", type: "section", title: "Actors", children: [] },
        { id: "screen-elements", type: "section", title: "Screen-Elements", children: [] },
        { id: "levels", type: "section", title: "Levels", children: [] },
