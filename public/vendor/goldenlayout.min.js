  ...
  (lm.utils.F = function () {}),
    ...
    (lm.utils.EventEmitter = function () {
      (this._mSubscriptions = {}),
        ...
        (this.emit = function (t) {
          var e, i, n;
          if (((n = Array.prototype.slice.call(arguments, 1)), this._mSubscriptions[t]))
            for (e = 0; e < this._mSubscriptions[t].length; e++)
              (i = this._mSubscriptions[t][e].ctx || {}), this._mSubscriptions[t][e].fn.apply(i, n);
          for (n.unshift(t), e = 0; e < this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT].length; e++)
            (i = this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT][e].ctx || {}),
              this._mSubscriptions[lm.utils.EventEmitter.ALL_EVENT][e].fn.apply(i, n);
        }),
      ...
      onMouseMove: function (t) {
        if (null != this._timeout) {
          ...
          (this._nX = e.x - this._nOriginalX),
            ...
            this._bDragging === !1 &&
              (Math.abs(this._nX) > this._nDistance || Math.abs(this._nY) > this._nDistance) &&
    ...
    (lm.LayoutManager = function (t, e) {
      if (!$ || "function" != typeof $.noConflict) {
        ...
        throw (
          ((i += 'Please either expose $ on GoldenLayout\'s scope (e.g. window) or add "jquery" to '),
    ...
    lm.utils.copy(lm.LayoutManager.prototype, {
          ...
          e = {
            ...
            i = function (t, e) {
              ...
              if (e.contentItems.length)
                for (t.content = [], s = 0; s < e.contentItems.length; s++) (t.content[s] = {}), i(t.content[s], e.contentItems[s]);
            },
      ...
      createContentItem: function (t, e) {
        ...
        if (
          ("react-component" === t.type && ((t.type = "component"), (t.componentName = "lm-react-component")),
          !this._typeToItem[t.type])
        )
          throw (
            ((i = "Unknown type '" + t.type + "'. Valid types are " + lm.utils.objectKeys(this._typeToItem).join(",")),
        ...
        return (
          "component" !== t.type ||
            ...
            (t = { type: "stack", width: t.width, height: t.height, content: [t] }),
      ...
      createPopout: function (t, e, i, n) {
        ...
        if (((i = i || null), c)) {
          for (
            m = this.toConfig(t).content, i = lm.utils.getUniqueId(), a = t.parent, h = t;
        ...
        return (
          !e &&
            ...
            (r = t.element.offset()),
            (e = { left: s + r.left, top: o + r.top, width: t.element.width(), height: t.element.height() })),
          e ||
            c ||
            (e = {
      ...
      _$getArea: function (t, e) {
        ...
        for (i = 0; i < this._itemAreas.length; i++)
          (n = this._itemAreas[i]), t > n.x1 && t < n.x2 && e > n.y1 && e < n.y2 && s > n.surface && ((s = n.surface), (o = n));
        return o;
      },
      _$createRootItemAreas: function () {
        ...
        for (side in sides) {
          ...
          with (((area.side = side), sides[side] ? (area[side] = area[sides[side]] - areaSize) : (area[side] = areaSize), area))
            surface = (x2 - x1) * (y2 - y1);
        ...
        var i = function (t) {
          for (var e in t)
            "props" !== e && "object" == typeof t[e]
              ? i(t[e])
              : "type" === e && "react-component" === t[e] && ((t.type = "component"), (t.componentName = "lm-react-component"));
        };
        return i(t), t.settings.hasHeaders === !1 && (t.dimensions.headerHeight = 0), t;
      },
      _adjustToWindowMode: function () {
        var t = $(
          '<div class="lm_popin" title="' + this.config.labels.popin + '"><div class="lm_icon"></div><div class="lm_bg"></div></div>'
        );
        t.click(
      ...
      _setContainer: function () {
        ...
        t[0] === document.body &&
          ((this._isFullPage = !0), $("html, body").css({ height: "100%", margin: 0, padding: 0, overflow: "hidden" })),
          (this.container = t);
      },
      _create: function (t) {
        var e;
        ...
        (this.root = new lm.items.Root(this, { content: t.content }, this.container)),
      ...
      _useResponsiveLayout: function () {
        return (
          ...
          ("always" == this.config.settings.responsiveMode || ("onload" == this.config.settings.responsiveMode && this._firstLoad))
        );
      },
    ...
    lm.utils.copy(lm.container.ItemContainer.prototype, {
      ...
      setSize: function (t, e) {
        for (var i, n, s, o, r, a, h = this.parent, l = this; !h.isColumn && !h.isRow; )
      ...
      _$setSize: function (t, e) {
        (t === this.width && e === this.height) ||
          ((this.width = t), (this.height = e), this._contentElement.width(this.width).height(this.height), this.emit("resize"));
      },
    }),
    ...
    lm.utils.copy(lm.controls.BrowserPopout.prototype, {
      ...
      popIn: function () {
        ...
        this._parentId &&
          ...
          e ||
            ((e =
              this._layoutManager.root.contentItems.length > 0 ? this._layoutManager.root.contentItems[0] : this._layoutManager.root),
            (i = 0))),
      ...
      _createUrl: function () {
        ...
        return (
          ...
          1 === t.length ? t[0] + "?gl-window=" + i : document.location.href + "&gl-window=" + i
        );
      },
    ...
    (lm.controls.DragProxy = function (t, e, i, n, s, o) {
      lm.utils.EventEmitter.call(this),
        ...
        o &&
          ...
          ["right", "bottom"].indexOf(o._side) >= 0 && this.element.find(".lm_content").after(this.element.find(".lm_header"))),
    ...
    lm.utils.copy(lm.controls.DragProxy.prototype, {
      ...
      _setDropPosition: function (t, e) {
        this.element.css({ left: t, top: e }),
          ...
          null !== this._area && ((this._lastValidArea = this._area), this._area.contentItem._$highlightDropZone(t, e, this._area));
      },
      _onDrop: function () {
    ...
    (lm.controls.Header = function (t, e) {
      lm.utils.EventEmitter.call(this),
        ...
        this.layoutManager.config.settings.selectionEnabled === !0 &&
          (this.element.addClass("lm_selectable"), this.element.on("click touchstart", lm.utils.fnBind(this._onHeaderClick, this))),
    ...
    lm.utils.copy(lm.controls.Header.prototype, {
        ...
        return (
          ...
          0 === this.tabs.length
            ...
            : (void 0 === e && (e = this.tabs.length),
              e > 0 ? this.tabs[e - 1].element.after(i.element) : this.tabs[0].element.before(i.element),
      ...
      setActiveContentItem: function (t) {
        ...
        for (e = 0; e < this.tabs.length; e++)
          (n = this.tabs[e].contentItem === t),
            ...
            n === !0 && ((this.activeContentItem = t), (this.parent.config.activeItemIndex = e));
        if (this._lastVisibleTabIndex !== -1 && this.parent.config.activeItemIndex > this._lastVisibleTabIndex) {
          for (s = this.tabs[this.parent.config.activeItemIndex], i = this.parent.config.activeItemIndex; i > 0; i--)
      ...
      position: function (t) {
        ...
        return (
          ...
          void 0 !== t && this.parent._header.show != t && ((this.parent._header.show = t), this.parent._setupHeaderPosition()),
          e
        );
      },
      ...
      _createControls: function () {
        ...
        (h = lm.utils.fnBind(this._showAdditionalTabsDropdown, this)),
          ...
          this._isClosable() &&
            ...
            (this.closeButton = new lm.controls.HeaderButton(this, i, "lm_close", t)));
      },
      ...
      _updateTabSizes: function () {
        if (0 !== this.tabs.length) {
          ...
          this.element.css(t(!this.parent._sided), ""),
            this.element[t(this.parent._sided)](this.layoutManager.config.dimensions.headerHeight);
          var e,
            i,
            n,
            s,
            ...
            a = !1;
          for (
            this.parent._sided && (o = this.element.outerHeight() - this.controlsContainer.outerHeight() - this._tabControlOffset),
              this._lastVisibleTabIndex = -1,
              i = 0;
            i < this.tabs.length;
            i++
            ...
            (e = this.tabs[i].element),
              ...
              (r += s),
              r > o && a
                ? (e.data("lastTabWidth", s), this.tabDropdownContainer.append(e))
                : ((a = !0), (this._lastVisibleTabIndex = i), e.removeData("lastTabWidth"), this.tabsContainer.append(e));
    ...
    lm.utils.copy(lm.controls.Splitter.prototype, {
      ...
      _createElement: function () {
        ...
        return (
          t.addClass("lm_" + (this._isVertical ? "vertical" : "horizontal")), t[this._isVertical ? "height" : "width"](this._size), t
        );
      },
    }),
    ...
    lm.utils.copy(lm.controls.Tab.prototype, {
      ...
      _onDragStart: function (t, e) {
        this.contentItem.parent.isMaximised === !0 && this.contentItem.parent.toggleMaximise(),
          new lm.controls.DragProxy(t, e, this._dragListener, this._layoutManager, this.contentItem, this.header.parent);
      },
    ...
    lm.utils.copy(lm.items.AbstractContentItem.prototype, {
      ...
      callDownwards: function (t, e, i, n) {
        var s;
        for (i !== !0 && n !== !0 && this[t].apply(this, e || []), s = 0; s < this.contentItems.length; s++)
      ...
      removeChild: function (t, e) {
        ...
        e !== !0 && this.contentItems[i]._$destroy(),
          ...
          this.contentItems.length > 0
            ...
            : this instanceof lm.items.Root || this.config.isClosable !== !0 || this.parent.removeChild(this);
      },
      ...
      toggleMaximise: function (t) {
        t && t.preventDefault(),
          this.isMaximised === !0 ? this.layoutManager._$minimiseItem(this) : this.layoutManager._$maximiseItem(this),
      ...
      deselect: function () {
        this.layoutManager.selectedItem === this &&
          ((this.layoutManager.selectedItem = null), this.element.removeClass("lm_selected"));
      },
      setTitle: function (t) {
        ...
        var e = [],
          i = function (n) {
            for (var s = 0; s < n.contentItems.length; s++)
              t(n.contentItems[s]) === !0 && e.push(n.contentItems[s]), i(n.contentItems[s]);
          };
        return i(this), e;
      },
      ...
      _createContentItems: function (t) {
        ...
        for (i = 0; i < t.content.length; i++)
          (e = this.layoutManager.createContentItem(t.content[i], this)), this.contentItems.push(e);
      },
      ...
      _scheduleEventPropagationToLayoutManager: function (t, e) {
        lm.utils.indexOf(t, this._throttledEvents) === -1
          ...
          : this._pendingEventPropagations[t] !== !0 &&
            ((this._pendingEventPropagations[t] = !0),
            lm.utils.animFrame(lm.utils.fnBind(this._propagateEventToLayoutManager, this, [t, e])));
      },
    ...
    lm.utils.copy(lm.items.Root.prototype, {
      ...
      _$onDrop: function (t, e) {
        ...
        if (
          (t.isComponent &&
            ((i = this.layoutManager.createContentItem({ type: "stack", header: t.config.header || {} }, this)),
            i._$init(),
            i.addChild(t),
            (t = i)),
    ...
    lm.utils.copy(lm.items.RowOrColumn.prototype, {
      addChild: function (t, e, i) {
        ...
        if (
          ...
          this.contentItems.length > 0
            ? ((r = this._createSplitter(Math.max(0, e - 1)).element),
              e > 0
                ? (this.contentItems[e - 1].element.after(r), r.after(t.element))
        ...
        for (o = 0; o < this.contentItems.length; o++)
          this.contentItems[o] === t
            ...
            : ((s = this.contentItems[o].config[this._dimension] *= (100 - n) / 100),
      ...
      removeChild: function (t, e) {
        ...
        for (
          this._splitter[r] && (this._splitter[r]._$destroy(), this._splitter.splice(r, 1)), i = 0;
      ...
      setSize: function () {
        this.contentItems.length > 0 && (this._calculateRelativeSizes(), this._setAbsoluteSizes()),
          this.emitBubblingEvent("stateChanged"),
          this.emit("resize");
      },
      _$init: function () {
        if (this.isInitialised !== !0) {
          var t;
          for (lm.items.AbstractContentItem.prototype._$init.call(this), t = 0; t < this.contentItems.length - 1; t++)
      ...
      _calculateRelativeSizes: function () {
        ...
        for (t = 0; t < this.contentItems.length; t++)
          void 0 !== this.contentItems[t].config[n] ? (e += this.contentItems[t].config[n]) : i.push(this.contentItems[t]);
        ...
        if (!(this._isColumn || !s || this.contentItems.length <= 1)) {
          for (o = this._calculateAbsoluteSizes(), i = 0; i < this.contentItems.length; i++)
            (c = this.contentItems[i]),
              (m = o.itemSizes[i]),
              m < s ? ((h += s - m), (n = { width: s })) : ((a += m - s), (n = { width: m }), r.push(n)),
              d.push(n);
          if (!(0 === h || h > a)) {
            for (t = h / a, l = h, i = 0; i < r.length; i++) (n = r[i]), (e = Math.round((n.width - s) * t)), (l -= e), (n.width -= e);
            for (0 !== l && (d[d.length - 1].width -= l), i = 0; i < this.contentItems.length; i++)
              this.contentItems[i].config.width = (d[i].width / o.totalWidth) * 100;
          }
        }
      },
      ...
      _onSplitterDragStart: function (t) {
        ...
        (this._splitterPosition = 0),
          (this._splitterMinPosition = -1 * (e.before.element[this._dimension]() - (s || i))),
          (this._splitterMaxPosition = e.after.element[this._dimension]() - (r || i));
      },
      _onSplitterDrag: function (t, e, i) {
        var n = this._isColumn ? i : e;
        n > this._splitterMinPosition &&
          n < this._splitterMaxPosition &&
          ((this._splitterPosition = n), t.element.css(this._isColumn ? "top" : "left", n));
      },
    ...
    lm.utils.copy(lm.items.Stack.prototype, {
      setSize: function () {
        ...
        for (this.childElementContainer.width(i), this.childElementContainer.height(n), t = 0; t < this.contentItems.length; t++)
      ...
      _$validateClosability: function () {
        var t, e, i;
        for (t = this.header._isClosable(), i = 0, e = this.contentItems.length; i < e && t; i++)
        ...
        for (i in this._contentAreaDimensions)
          if (((n = this._contentAreaDimensions[i].hoverArea), n.x1 < t && n.x2 > t && n.y1 < e && n.y2 > e))
            return void ("header" === i
              ? ((this._dropSegment = "header"), this._highlightHeaderDropZone(this._sided ? e : t))
        ...
        return (
          ...
          this._activeContentItem && this._activeContentItem.isComponent === !1
            ...
            : ((this._contentAreaDimensions.left = {
                hoverArea: { x1: i.x1, y1: i.y1, x2: i.x1 + 0.25 * n, y2: i.y2 },
                highlightArea: { x1: i.x1, y1: i.y1, x2: i.x1 + 0.5 * n, y2: i.y2 },
              }),
              (this._contentAreaDimensions.top = {
                hoverArea: { x1: i.x1 + 0.25 * n, y1: i.y1, x2: i.x1 + 0.75 * n, y2: i.y1 + 0.5 * s },
                highlightArea: { x1: i.x1, y1: i.y1, x2: i.x2, y2: i.y1 + 0.5 * s },
              }),
              (this._contentAreaDimensions.right = {
                hoverArea: { x1: i.x1 + 0.75 * n, y1: i.y1, x2: i.x2, y2: i.y2 },
                highlightArea: { x1: i.x1 + 0.5 * n, y1: i.y1, x2: i.x2, y2: i.y2 },
              }),
              (this._contentAreaDimensions.bottom = {
                hoverArea: { x1: i.x1 + 0.25 * n, y1: i.y1 + 0.5 * s, x2: i.x1 + 0.75 * n, y2: i.y2 },
                highlightArea: { x1: i.x1, y1: i.y1 + 0.5 * s, x2: i.x2, y2: i.y2 },
              }),
              t.call(this, this.element))
        );
      },
      _highlightHeaderDropZone: function (t) {
        ...
        for (e = 0; e < m; e++)
          if (
            ...
            (o = i.offset()),
            this._sided ? ((s = o.top), (n = o.left), (h = i.height())) : ((s = o.left), (n = o.top), (h = i.width())),
            t > s && t < s + h)
          ) {
            c = !0;
            break;
        ...
        if (!(c === !1 && t < s)) {
          if (
            ((l = s + h / 2),
            t < l
              ? ((this._dropIndex = e), i.before(this.layoutManager.tabDropPlaceholder))
              : ((this._dropIndex = Math.min(e + 1, m)), i.after(this.layoutManager.tabDropPlaceholder)),
            this._sided)
          )
            return (
        ...
        for (n in t)
          t instanceof Array && (n = parseInt(n, 10)),
            t.hasOwnProperty(n) &&
              ...
              "object" == typeof t[n]
                ? ((e[s] = t[n] instanceof Array ? [] : {}), this._nextLevel(t[n], e[s], i))
    ...
    (lm.utils.EventHub.prototype._onEventFromThis = function () {
      ...
      this._layoutManager.isSubWindow && t[0] !== this._dontPropagateToParent && this._propagateToParent(t),
    ...
    (lm.utils.EventHub.prototype._propagateToParent = function (t) {
      ...
      document.createEvent
        ? ((e = window.opener.document.createEvent("HTMLEvents")), e.initEvent(i, !0, !0))
    ...
    (lm.utils.EventHub.prototype._propagateToChildren = function (t) {
      ...
      for (i = 0; i < this._layoutManager.openPopouts.length; i++)
        (e = this._layoutManager.openPopouts[i].getGlInstance()),
          e && e !== this._childEventSource && e.eventHub._$onEventFromParent(t);
    }),
