        ...
        m.event.special[a] = {
          ...
          handle: function (a) {
            var c,
              ...
              f = a.handleObj;
            return (
              (!e || (e !== d && !m.contains(d, e))) && ((a.type = f.origType), (c = f.handler.apply(this, arguments)), (a.type = b)),
              c
            );
          },
        };
  ...
  (m.Tween = Zb),
    (Zb.prototype = {
      ...
      run: function (a) {
        ...
        return (
          (this.pos = b =
            this.options.duration ? m.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : a),
